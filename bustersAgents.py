...
class PolicyGradientPAgent(BustersAgent):
    ...
    def getReward(self, state, nextState):
        ...
        ################################## SPANISH ##################################
        # Necesito que sea positivo	numericamente hablando							#
        # El tiempo debe penalizar													#
        # Los fantasmas deben tener un impacto positivo								#
        # Ganar la partida debe ser buenisimo										#
